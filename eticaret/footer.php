			...
			<div class="row">
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						<li class="fphone"><?php echo $row['tel']?> <br> <?php echo $row['tel']?></li>
						<li class="fmobile"><?php echo $row['gsm']?><br><?php echo $row['gsm']?></li>
						<li class="fmail lastone"><?php echo $row['mail']?><br><?php echo $row['mail']?></li>
					</ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;All rights reserved by <a href="#"><?php echo $row['author']?></a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						<a href="http://<?php echo $row['twitter']?>" class="ftwitter">twitter</a>
						<a href="http://<?php echo $row['facebook']?>" class="ffacebook">facebook</a>
						<a href="http://<?php echo $row['youtube']?>" class="fflickr">youtube</a>
						<a href="http://<?php echo $row['google']?>" class="ffeed">google</a>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
				</div><!--footer Share-->
