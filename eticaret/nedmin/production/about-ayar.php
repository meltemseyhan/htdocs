          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Hakkımızda <small><?php echo $durum?></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form action="../netling/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="baslik">Hakkımızda Başlığı <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="baslik" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $rowAbout['baslik']?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea name="icerik" id="icerik" required="required" class="ckeditor"><?php echo $rowAbout['icerik']?></textarea>
                          <script>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="video" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $rowAbout['video']?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="vizyon" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $rowAbout['vizyon']?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="misyon" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $rowAbout['misyon']?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div style="text-align: right;" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" name="updateabout" class="btn btn-success">Güncelle</button>
                        </div>
                      </div>
