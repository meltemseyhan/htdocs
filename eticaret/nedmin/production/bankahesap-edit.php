...
$statementBankahesap = $db->prepare("SELECT * FROM bankahesap WHERE id=:id");
$statementBankahesap->execute(
  array(
    "id"=>$_GET['id']
  )
);
$rowBankahesap=$statementBankahesap->fetch(PDO::FETCH_ASSOC);
?>
                    ...
                    <form action="../netling/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="id" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $rowBankahesap['id']?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="ad" class="form-control col-md-7 col-xs-12" value="<?php echo $rowBankahesap['ad']?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="iban" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $rowBankahesap['iban']?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="adsoyad" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $rowBankahesap['adsoyad']?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="durum" required="required" class="form-control" value="<?php echo $rowBankahesap['durum']?>">
                            <option value='0' <?php echo $rowBankahesap['durum']=='0'?'selected':''?>>Pasif</option>
                            <option value='1' <?php echo $rowBankahesap['durum']=='1'?'selected':''?>>Aktif</option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div style="text-align: right;" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" name="updatebankahesap" class="btn btn-success">Güncelle</button>
                        </div>
                      </div>
